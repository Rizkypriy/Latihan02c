    ...
    <div class="container table-container">
        ...
        <div class="navigation-bar mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(url('/')); ?>"><i class="bi bi-house-door"></i> Home</a>
                        </li>
                ...
                <div class="btn-group">
                    <a href="<?php echo e(route('matakuliah.index')); ?>" class="btn btn-outline-primary btn-sm">
                        <i class="bi bi-book me-1"></i> Ke Mata Kuliah
                    </a>
                    <a href="<?php echo e(route('mahasiswa.create')); ?>" class="btn btn-success btn-sm">
        ...
        <div class="table-header">
            <h3 class="mb-0">
                ...
                <a href="<?php echo e(route('mahasiswa.create')); ?>" class="btn btn-success btn-sm btn-add">
                    <i class="bi bi-plus-circle"></i> Tambah Mahasiswa
                </a>
            </h3>
            <p class="mb-0 mt-1 text-light" style="opacity: 0.8;">
                Total: <?php echo e($mahasiswas->count()); ?> mahasiswa
            </p>
        </div>
                            ...
                            <div class="action-buttons justify-content-center">
                                ...
                                <form action="<?php echo e(route('mahasiswa.destroy', $mahasiswa->nim)); ?>" 
                                    ...
                                    <button type="submit" 
                                            ...
                                            title="Hapus"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus mahasiswa <?php echo e($mahasiswa->nama); ?>?')">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="alert alert-info">
                    ...
                    Total: <strong><?php echo e($mahasiswas->count()); ?></strong> mahasiswa terdaftar
                </div>
            </div>
            <div class="col-md-6 text-end">
                <small class="text-muted">
                    Terakhir diperbarui: <?php echo e(now()->format('d F Y H:i')); ?>
