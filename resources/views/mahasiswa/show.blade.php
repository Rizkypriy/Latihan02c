    ...
    <div class="container">
        ...
        <div class="detail-container mt-4">
            ...
            <div class="detail-header">
                ...
                <h1 class="mb-2">{{ $mahasiswa->nama }}</h1>
                <p class="mb-0 opacity-75">
                    <i class="bi bi-card-text"></i> NIM: {{ $mahasiswa->nim }}
                </p>
            </div>
            ...
            <div class="detail-body">
                ...
                <div class="card-info">
                    ...
                    <p class="mb-0 text-muted">
                        Data lengkap mahasiswa {{ $mahasiswa->nama }} dengan NIM {{ $mahasiswa->nim }}
                    </p>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                <strong class="text-primary">{{ $mahasiswa->nim }}</strong>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <small class="text-muted">
                                        ...
                                        Ditambahkan: 
                                        <strong>{{ $mahasiswa->created_at->format('d F Y H:i') }}</strong>
                                    </small>
                                </div>
                                @endif
                                ...
                                <div class="col-md-6">
                                    <small class="text-muted">
                                        ...
                                        Terakhir diupdate: 
                                        <strong>{{ $mahasiswa->updated_at->format('d F Y H:i') }}</strong>
                                    </small>
                                </div>
                                @endif
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="mt-2 mb-0">
                            ...
                            <li>Kelas: <strong>{{ $mahasiswa->kelas }}</strong></li>
                        </ul>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (copyNIM) {
                copyNIM.addEventListener('click', function() {
                    navigator.clipboard.writeText('{{ $mahasiswa->nim }}')
                        .then(() => {
